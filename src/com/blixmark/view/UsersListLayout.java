...
public class UsersListLayout implements Layout {
     ...
     */
    public UsersListLayout() {
        this.tableModel = new TableUserModel();
    ...
    private void customUI() {
        ...
        // Caret
        this.searchInput.setCaretColor(new Color(51,51,51));
     ...
     */
    public TableUserModel getTableModel() {
